...
* To view Classic virtual server Sysdig metrics, see [Classic virtual server instance metrics definitions](/docs/virtual-servers?topic=virtual-servers-classic-sysdig-metrics).
* To view VPC virtual server Sysdig metrics, see [VPC virtual server instances metrics definitions](/docs/vpc?topic=vpc-vpc-sysdig-metrics)
