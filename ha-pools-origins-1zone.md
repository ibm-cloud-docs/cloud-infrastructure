...
![Deploying server pools and origins in a single MZR.](images/ha-pools-origins-1zone.png){:caption="Figure 1. Deploying server pools and origins in a single MZR" caption-side="bottom"}
