...
2. Assess the databases for potential migration issues or blockers, and then resolve any items that you might have uncovered.
...
| [Generate script](/docs/cloud-infrastructure?topic=cloud-infrastructure-mssql-db-overview#generate-script) | Small data migration or schema-only migration |
